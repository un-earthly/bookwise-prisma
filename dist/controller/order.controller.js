...
const categoryController = {
    ...
    getAllOrders: (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const orders = yield order_service_1.default.getAllOrders(); // Assuming you have a method in OrderService to fetch all orders
    ...
    getSingleOrder: (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const order = yield order_service_1.default.getSingleOrder(orderId); // Assuming you have a method in OrderService to fetch a single order by ID
        if (!order) {
